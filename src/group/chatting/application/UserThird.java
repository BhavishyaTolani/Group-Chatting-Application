...
public class UserThird extends JFrame implements ActionListener, Runnable{
    ...
    UserThird(){
       ...
       ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("groupIcon.jpg"));
       ...
       JLabel l4 = new JLabel("Bhavishya, Nayan, Aamiya, Muskan");
    ...
    public void actionPerformed(ActionEvent ae){
        String str = "Bhavishya: "+t1.getText();
        try{
            writer.write(str);
            writer.write("\r\n");
            writer.flush();
